...
describe SuitableClassFinder do
  ...
  it "should allow a block to be given wich specify the matcher" do
    (SuitableClassFinder.find_leaf_subclass_of (AbstractClass1){|subclass| subclass.zzz? 1, 2, 3}).should eq(ConcreteClass1)
  end
